...
angular.module('ionicValidateWithToast', []).directive('bsyFormValidate', ["toastr", function (toastr) {
  return {
    restrict: 'A',
    require: 'ngModel',
    scope: {
    ...
    link: function link(scope, element, attrs, ctrl) {
      ...
      var showTopToastShort = function showTopToastShort(msg) {
        toastr.error(msg);
      };
...
}]).directive('checkForm', ["$parse", "$timeout", function ($parse, $timeout) {
  return {
    require: '^form',
    restrict: 'A',
