...
(function(angular){
    ...
    function LeaveDetailConfig($stateProvider) {
        ...
        $stateProvider
            ...
            .state('app.agreeLeave',
                {
                    url: '/approve/leave/leaveDetail/auditDetail',
                    params: {
                        leaveApplyId: 0,
                        staffId: 0,
                        auditId: 0,
                    ...
                    views: {
                        'tab-home': {
                            templateUrl: MobilePublic.getServerUrl('app/approve/leave/leaveDetail/auditDetail/AgreeLeave.html'),
                            controller: 'agreeLeaveController',
                            controllerAs: 'vm',
                            resolve: {
                                loadPlugin: function ($ocLazyLoad) {
                                    return $ocLazyLoad.load([
                                        {
                                            files: [
                                                MobilePublic.getServerUrl('app/approve/leave/leaveDetail/auditDetail/AgreeLeaveController.js')
                                            ]
                                        }
                                    ]);
                                }
