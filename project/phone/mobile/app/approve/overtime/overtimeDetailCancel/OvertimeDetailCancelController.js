...
(function(angular){
    "use strict";
    angular.module('app')
        .controller('overtimeDetailCancelController', OvertimeDetailCancelController);
    /* @ngInject */
    function OvertimeDetailCancelController($scope, $rootScope, $ionicHistory,Restangular,$stateParams,toastr,auth,$state){
        var vm = this;
        ...
        getOtDetailCancelList();
        //取得老人一览
        function getOtDetailCancelList() {
            ...
            var proc = Restangular.all('reqOvertimeDetailCancel');
            proc.post(vm.credentials).then(function(ret) {
                if (ret.returnCode == "0") {
                    ...
                    vm.otTimeModify = vm.formatterMoney(ret.otTime);
                    var date = new Date(ret.otStartModify);
