...
(function(angular){
    "use strict";
    angular.module('app')
        .controller('serviceSearchPersonListController', ServcieSearchPersonListController);
    /* @ngInject */
    function ServcieSearchPersonListController($scope, $rootScope, setting,Restangular,$stateParams,toastr, ionicDatePicker){
        var vm = this;
        vm.page = 0;
        vm.isLock=false;
        ...
        function getPersonList() {
            ...
            var proc = Restangular.all('reqServiceSearchPersonList');
