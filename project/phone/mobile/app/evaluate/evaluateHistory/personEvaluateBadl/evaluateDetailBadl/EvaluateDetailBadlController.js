...
(function(angular){
    "use strict";
    angular.module('app')
        .controller('evaluateDetailBadlController', EvaluateDetailBadlController);
    /* @ngInject */
    function EvaluateDetailBadlController($scope, $rootScope,$ionicHistory, Restangular,$stateParams,$ionicPopup){
        var vm = this;
        vm.message="";
