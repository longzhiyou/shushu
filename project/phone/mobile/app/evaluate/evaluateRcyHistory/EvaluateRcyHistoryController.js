...
(function(angular){
    "use strict";
    angular.module('app')
        .controller('evaluateRcyHistoryController', EvaluateRcyHistoryController);
    /* @ngInject */
    function EvaluateRcyHistoryController($scope,$rootScope, Restangular,$stateParams,toastr,$state){
        var vm = this;
        vm.page = 0;
        vm.isLock=false;
