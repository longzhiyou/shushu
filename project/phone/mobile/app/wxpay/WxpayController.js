...
(function(angular){
    "use strict";
    angular.module('app')
        .controller('wxpayController', WxpayController);
    /* @ngInject */
    function WxpayController($scope, $rootScope, Restangular,$stateParams,$ionicHistory,$state,toastr,auth,$cordovaInAppBrowser,$interval,$ionicPopup) {
        var vm = this;
        ...
        function init(){
            vm.pay = true;
            vm.complete = false;
            vm.targetUrl = MobilePublic.Api + 'reqWxPay?id='+vm.id;
